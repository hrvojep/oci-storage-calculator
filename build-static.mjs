...
const files = ["index.html", "styles.css", "currency.css", "script.js"];
const content = {};
...
const types = { "index.html": "text/html; charset=utf-8", "styles.css": "text/css; charset=utf-8", "currency.css": "text/css; charset=utf-8", "script.js": "text/javascript; charset=utf-8" };
export default {
  async fetch(request) {
